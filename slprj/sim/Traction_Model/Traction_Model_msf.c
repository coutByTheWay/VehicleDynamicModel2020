...
#define S_FUNCTION_NAME Traction_Model_msf
#endif
...
hupbxjr5fjc * dw = ( hupbxjr5fjc * ) ssGetDWork ( S , 0 ) ; mk15kpcwx1 *
localX = ( mk15kpcwx1 * ) ssGetContStates ( S ) ; mxvoph4n2k ( localX ) ; }
static void mdlReset ( SimStruct * S ) { hupbxjr5fjc * dw = ( hupbxjr5fjc * )
ssGetDWork ( S , 0 ) ; mk15kpcwx1 * localX = ( mk15kpcwx1 * ) ssGetContStates
( S ) ; gzopvquhr4 ( localX ) ; } static void mdlPeriodicOutputUpdate (
SimStruct * S , int_T tid ) { hupbxjr5fjc * dw = ( hupbxjr5fjc * ) ssGetDWork
( S , 0 ) ; const real_T * i_aa0d0c454t = ( real_T * ) ssGetInputPortSignal (
S , 0 ) ; real_T * o_B_3_1 = ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ;
real_T * o_B_3_2 = ( real_T * ) ssGetOutputPortSignal ( S , 1 ) ; mk15kpcwx1
* localX = ( mk15kpcwx1 * ) ssGetContStates ( S ) ; if ( tid == 0 ) {
Traction_Model ( & ( dw -> rtm ) , i_aa0d0c454t , o_B_3_1 , o_B_3_2 , & ( dw
-> rtb ) , localX ) ; dfuikadvmz ( & ( dw -> rtm ) ) ; } } static void
...
1 , 2 ) ; if ( ! ssSetNumInputPorts ( S , 1 ) ) return ; if ( !
...
mr_Traction_Model_RegisterSimStateChecksum ( S ) ; ssSetNumSampleTimes ( S ,
...
mr_Traction_Model_MdlInfoRegFcn ( S , "Traction_Model" , & retVal ) ; if ( !
retVal ) return ; }
#endif
#if SS_SFCN_FOR_SIM
if ( ssSetNumDWork ( S , 1 ) ) { int mdlrefDWTypeId ; ssRegMdlRefDWorkType (
S , & mdlrefDWTypeId ) ; if ( mdlrefDWTypeId == INVALID_DTYPE_ID ) return ;
if ( ! ssSetDataTypeSize ( S , mdlrefDWTypeId , sizeof ( hupbxjr5fjc ) ) )
...
static void mdlSetupRuntimeResources ( SimStruct * S ) { hupbxjr5fjc * dw = (
hupbxjr5fjc * ) ssGetDWork ( S , 0 ) ; mk15kpcwx1 * localX = ( mk15kpcwx1 * )
ssGetContStates ( S ) ; void * sysRanPtr = ( NULL ) ; int sysTid = 0 ;
ssGetContextSysRanBCPtr ( S , & sysRanPtr ) ; ssGetContextSysTid ( S , &
sysTid ) ; if ( sysTid == CONSTANT_TID ) { sysTid = 0 ; } h4khlhkpbr ( S ,
...
* S , int_T tid ) { hupbxjr5fjc * dw = ( hupbxjr5fjc * ) ssGetDWork ( S , 0 )
; const real_T * i_aa0d0c454t = ( real_T * ) ssGetInputPortSignal ( S , 0 ) ;
real_T * o_B_3_1 = ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ; real_T *
o_B_3_2 = ( real_T * ) ssGetOutputPortSignal ( S , 1 ) ; mk15kpcwx1 * localX
= ( mk15kpcwx1 * ) ssGetContStates ( S ) ; if ( tid == PARAMETER_TUNING_TID )
{ Traction_ModelTID2 ( ) ; } if ( tid != CONSTANT_TID && tid !=
PARAMETER_TUNING_TID ) { if ( ssIsSampleHit ( S , 0 , tid ) ||
ssIsMinorTimeStep ( S ) ) { Traction_Model ( & ( dw -> rtm ) , i_aa0d0c454t ,
o_B_3_1 , o_B_3_2 , & ( dw -> rtb ) , localX ) ; } } }
#define MDL_UPDATE
static void mdlUpdate ( SimStruct * S , int_T tid ) { hupbxjr5fjc * dw = (
hupbxjr5fjc * ) ssGetDWork ( S , 0 ) ; if ( ssIsSampleHit ( S , 0 , tid ) ) {
dfuikadvmz ( & ( dw -> rtm ) ) ; } return ; }
#define MDL_DERIVATIVES
static void mdlDerivatives ( SimStruct * S ) { hupbxjr5fjc * dw = (
hupbxjr5fjc * ) ssGetDWork ( S , 0 ) ; miqt3mwx52 * localXdot = ( miqt3mwx52
* ) ssGetdX ( S ) ; k4l0fa3the ( & ( dw -> rtb ) , localXdot ) ; } static
void mdlTerminate ( SimStruct * S ) { hupbxjr5fjc * dw = ( hupbxjr5fjc * )
ssGetDWork ( S , 0 ) ; bivkusxkvs ( & ( dw -> rtm ) ) ; return ; }
...
simStateFieldNames ) ; { const mk15kpcwx1 * localX = ( const mk15kpcwx1 * )
ssGetContStates ( S ) ; const size_t numBytes = sizeof ( mk15kpcwx1 ) ;
...
storedX ) ; } { mxArray * mdlrefDW = mr_Traction_Model_GetDWork ( ssGetDWork
( S , 0 ) ) ; mxSetFieldByNumber ( ss , 0 , 1 , mdlrefDW ) ; } { mxArray *
data = mr_Traction_Model_GetSimStateDisallowedBlocks ( ) ; mxSetFieldByNumber
...
mk15kpcwx1 * localX = ( mk15kpcwx1 * ) ssGetContStates ( S ) ; const size_t
numBytes = sizeof ( mk15kpcwx1 ) ; const mxArray * storedX =
mxGetFieldByNumber ( ss , 0 , 0 ) ; const UINT8_T * rawData = ( const UINT8_T
* ) mxGetData ( storedX ) ; memcpy ( localX , & rawData [ 0 ] , numBytes ) ;
} mr_Traction_Model_SetDWork ( ssGetDWork ( S , 0 ) , mxGetFieldByNumber ( ss
