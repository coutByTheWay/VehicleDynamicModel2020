...
MODEL                   = Traction_Model
MODULES                 = Traction_Model.c Traction_Model_capi.c
PRODUCT                 = Traction_Modellib.a
MAKEFILE                = Traction_Model.mk
MATLAB_ROOT             = /usr/local/MATLAB/R2020a
ALT_MATLAB_ROOT         = /usr/local/MATLAB/R2020a
MASTER_ANCHOR_DIR       = 
START_DIR               = /home/noel/Desktop/Controls_HybridPowerTrain/FCVD/VehicleDynamicModel2020
S_FUNCTIONS_LIB         = 
NUMST                   = 2
NCSTATES                = 1
COMPUTER                = GLNXA64
...
DEFINES_CUSTOM          = 
SYSTEM_LIBS             = -L"/usr/local/MATLAB/R2020a/bin/glnxa64" -lfixedpoint -lmwmathutil -lmwipp -lmwsl_AsyncioQueue -lmwsf_runtime -lmwslexec_simlog -lmwcoder_ToAsyncQueueTgtAppSvc -lmwsl_simtarget_instrumentation -lmwsl_simtarget_core -lmwstringutil -lcovrt
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/sim/Traction_Model \
